    ...
    <main>
        ...
        <div class="grid">
            ...
            <div class="box box-2" style="background: linear-gradient(
                rgba(0, 0, 0, 0.4),
                rgba(0, 0, 0, 0.4)
                ),url(<?php echo ASSETS.'images/meditate.jpg';?>); background-size: cover;" onclick="window.location.href = '<?php echo BASE_URL.'meditation';?>';">
                MEDITATE
            </div>
            <div class="box box-3" style="background: linear-gradient(
                rgba(0, 0, 0, 0.4),
                rgba(0, 0, 0, 0.4)
              ),url(<?php echo ASSETS.'images/habits.jpg';?>); background-size: cover;" onclick="window.location.href = '<?php //echo BASE_URL.'habituation';?>';">
                HABITAUATION
            </div>
            ...
            <div class="box box-4" style="background: linear-gradient(
                rgba(0, 0, 0, 0.4),
                rgba(0, 0, 0, 0.4)
              ),url(<?php echo ASSETS.'images/chill_music.jpg';?>); background-size: cover;" onclick="window.location.href = '<?php //echo BASE_URL.'chill-music';?>';">CHILL MUSIC</div>
